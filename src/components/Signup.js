...
export default function Signup() {
  ...
  // async function abc() {
  //   const msgValue = await designation.current.value;
  ...
  return (
    <>
      <div className="signUpscreen">
        ...
        <h1 className="topText">Make the most of your professional life</h1>
        <div className="signupCard">
          ...
          <form className="signupForm" onSubmit={handleSubmit}>
            ...
            <input
              ...
              required
            />
            <label className="formLabelSignup">
            ...
            <input
              ...
              required
            />
            <label className="formLabelSignup">Password Confirmation</label>
            <input
              className="formInputSignup"
              type="password"
            ...
            <p className="extraText">
              ...
              <span> User Agreement, Privacy Policy, and Cookie Policy</span>.
            </p>
